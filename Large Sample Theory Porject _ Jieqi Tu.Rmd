...
However, in order to estimate the variance parameter, the unbiased estimator would be $\frac{\sum{(\bar{x_i}-\bar{\bar{x}})^2}}{1000-1}$ (This result we used here was proved in Large Sample Theory Homework 2).
Hence the unbiased estimator for the population variance $k\theta$ would be 
...
In Large Sample Theory Homework 2, we have shown that $s_i^2\rightarrow\sigma^2$.
