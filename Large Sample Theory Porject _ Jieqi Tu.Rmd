...
Since each element in the sample follows $Gamma(k,\theta)$, according to Lindeberg-Levy CLT, we have:
$$\sqrt{n}(\bar{X_i}-k\theta) \xrightarrow{\text{d}}N(0,k\theta^2)$$
Since  $\bar{\bar{s_1^2}}=\frac{\sum{(\bar{x_i}-\bar{\bar{x}})^2}}{1000}\times n$
